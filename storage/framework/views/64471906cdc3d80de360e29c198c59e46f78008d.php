...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Lighting Consultant</title>
        ...
        <div class="side-navigation-scroll-pane">
            <div class="side-navigation-inner">
                ...
                <nav class="side-navigation">
                    <ul>
                        <li class="<?php echo $__env->yieldContent('nav-lading'); ?>">
                            <a href="<?php echo e(url('/')); ?>" class="contains-sub-menu">Home</a>
                        </li>
                        <li class="<?php echo $__env->yieldContent('nav-projects'); ?>">
                            <a href="<?php echo e(url('/projects')); ?>" class="contains-sub-menu">Projects</a>
                        </li>
                        <li class="<?php echo $__env->yieldContent('nav-about'); ?>">
                            <a href="<?php echo e(url('/about')); ?>" class="contains-sub-menu">About Us</a>
                            <ul class="sub-menu">
                                <li class="<?php echo $__env->yieldContent('nav-philosophy'); ?>">
                                    <a href="<?php echo e(url('/about#philosophy')); ?>">Philosophy</a>
                                </li>
                                <li class="<?php echo $__env->yieldContent('nav-services'); ?>">
                                    <a href="<?php echo e(url('/about#services')); ?>">Services</a>
                                </li>
                                <li class="<?php echo $__env->yieldContent('nav-teams'); ?>">
                                    <a href="<?php echo e(url('/about#teams')); ?>">Teams</a>
                                </li>
                            </ul>
                        </li>
                        <li class="<?php echo $__env->yieldContent('nav-careers'); ?>">
                            <a href="<?php echo e(url('/careers')); ?>" class="contains-sub-menu">Careers</a>
                        </li>
                        <li class="<?php echo $__env->yieldContent('nav-article'); ?>">
                            <a href="<?php echo e(url('/article')); ?>" class="contains-sub-menu">Article</a>
                        </li>
                        <li class="<?php echo $__env->yieldContent('nav-contact'); ?>">
                            <a href="<?php echo e(url('/contact')); ?>" class="contains-sub-menu">Contact</a>
                        </li>
                    </ul>
                </nav>
                    ...
                    <div class="row nav-bar">
                        <div class="column width-12 nav-bar-inner">
                            ...
                            <nav class="navigation nav-block primary-navigation nav-right no-margin-right">
                                <ul>
                                    <li class="<?php echo $__env->yieldContent('nav-landing'); ?>">
                                        <a href="<?php echo e(url('/')); ?>">Home</a>
                                    </li>
                                    <li class="<?php echo $__env->yieldContent('nav-projects'); ?>">
                                        <a href="<?php echo e(url('/projects')); ?>">Projects</a>
                                    </li>
                                    <li class="<?php echo $__env->yieldContent('nav-about'); ?> contains-mega-sub-menu">
                                        <a href="<?php echo e(url('/about')); ?>">About Us</a>
                                        <ul class="sub-menu">
                                            <li class="<?php echo $__env->yieldContent('nav-philosophy'); ?>">
                                                <a href="<?php echo e(route('about_us')); ?>#philosophy">Philosophy</a>
                                            </li>
                                            <li class="<?php echo $__env->yieldContent('nav-services'); ?>">
                                                <a href="<?php echo e(route('about_us')); ?>#services">Services</a>
                                            </li>
                                            <li class="<?php echo $__env->yieldContent('nav-teams'); ?>">
                                                <a href="<?php echo e(route('about_us')); ?>#teams">Teams</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="<?php echo $__env->yieldContent('nav-careers'); ?>">
                                        <a href="<?php echo e(url('/careers')); ?>">Careers</a>
                                    </li>
                                    <li class="<?php echo $__env->yieldContent('nav-article'); ?>">
                                        <a href="<?php echo e(url('/article')); ?>">Article</a>
                                    </li>
                                    <li class="<?php echo $__env->yieldContent('nav-contact'); ?> sub-menu-right">
...
</html><?php /**PATH /Users/evansaragih/Documents/Files/BINAR/Website/2022/binar-alightingstudio/resources/views/layout/layout.blade.php ENDPATH**/ ?>