<?php $__env->startSection('title', 'Villa Beraban | BINAR a Lighting Studio'); ?>
    ...
    <div class="section-block pt-70">
        <div class="row">
            <div class="column width-5">
                <h1 class="mb-50 title-medium">VILLA BERABAN</h1>
            </div>
            ...
            <div class="column width-4">
                <p class="project-attribute">
                    <span class="project-label">Location:</span><span class="project-value">Kerobokan, Bali</span>
                </p>
            </div>
        </div>
    </div>
...
<!-- Content End -->
<!-- Js -->
<script src="/assets/js/portfolio/villaBeraban.js"></script>
<script src="/assets/js/otherProjects.js"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.layout-project', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evansaragih/Documents/Files/BINAR/Website/2022/binar-alightingstudio/resources/views/projects/villaBeraban.blade.php ENDPATH**/ ?>