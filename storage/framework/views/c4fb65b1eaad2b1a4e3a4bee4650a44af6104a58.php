<?php $__env->startSection('title', 'BINAR a Lighting Studio'); ?>
<?php $__env->startSection('nav-landing', 'current'); ?>
                        ...
                        <div class="tms-content-inner left v-align-middle">
                            <div class="row">
                                <div class="column width-5 offset-7">
                                    ...
                                    <div class="clear"></div>
                                    <a href="<?php echo e(url('/projects/ulamanRetreat')); ?>" class="tms-caption mt-20 button small border-white color-white bkg-hover-theme color-hover-blue" data-animate-in="preset:slideInUpShort;duration:1000ms;delay:800ms;" data-no-scale>
                                        View Details
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tms-content-inner left v-align-middle">
                            <div class="row">
                                <div class="column width-5">
                                    ...
                                    <div class="clear"></div>
                                    <a href="<?php echo e(url('/projects/harrisHotelTuban')); ?>" class="tms-caption mt-20 button small border-white color-white bkg-hover-theme color-hover-blue" data-animate-in="preset:slideInUpShort;duration:1000ms;delay:800ms;" data-no-scale>
                                        View Details
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tms-content-inner left v-align-middle">
                            <div class="row">
                                <div class="column width-5 offset-7">
                                    ...
                                    <div class="clear"></div>
                                    <a href="<?php echo e(url('/projects/karmaResidence')); ?>" class="tms-caption mt-20 button small border-white color-white bkg-hover-theme color-hover-blue" data-animate-in="preset:slideInUpShort;duration:1000ms;delay:800ms;" data-no-scale>
                                        View Details
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tms-content-inner left v-align-middle">
                            <div class="row">
                                <div class="column width-5">
                                    ...
                                    <div class="clear"></div>
                                    <a href="<?php echo e(url('/projects/villaBeraban')); ?>" class="tms-caption mt-20 button small border-white color-white bkg-hover-theme color-hover-blue" data-animate-in="preset:slideInUpShort;duration:1000ms;delay:800ms;" data-no-scale>
                                        View Details
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="tms-content-inner left v-align-middle">
                            <div class="row">
                                <div class="column width-5 offset-7">
                                    ...
                                    <div class="clear"></div>
                                    <a href="<?php echo e(url('/projects/noaaSocialDining')); ?>" class="tms-caption mt-20 button small border-white color-white bkg-hover-theme color-hover-blue" data-animate-in="preset:slideInUpShort;duration:1000ms;delay:800ms;" data-no-scale>
                                        View Details
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evansaragih/Documents/Files/BINAR/Website/2022/binar-alightingstudio/resources/views/landing_page.blade.php ENDPATH**/ ?>